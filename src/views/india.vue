...
<div class="container mt-5">
  ...
  <section class="dark-grey-text">
    ...
    <!-- Section heading -->
    <h2 class="text-center font-weight-bold mb-4 pb-2">COVID-19 INDIA</h2>
    <!-- Section description -->
    <p class="text-center mx-auto w-responsive mb-5">For any technical enquiry with respect to COVID19, you may kindly email on technicalquery.covid19@gov.in</p>
